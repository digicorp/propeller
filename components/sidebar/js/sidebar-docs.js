...
$(document).ready(function() {
	...
	// Left Sidebar
	$('.pmd-sidebar-toggle').on( 'touchstart click', function(e) {
	...
	// Right Sidebar
	$('.pmd-sidebar-toggle-right').on( 'touchstart click', function(e) {
	...
	// Right Sidebar
	$('.pmd-topbar-toggle').on( 'touchstart click', function(e) {
	...
	// Nave bar in Sidebar
    $('.pmd-navbar-toggle').on('touchstart click', function(e) {
	...
	$('.pmd-navbar-sidebar .dropdown').on({
