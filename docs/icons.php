<link rel="stylesheet" type="text/css" href="../components/icons/css/google-icons.css">
<!--header start -->
	...
	<div class="container">
		...
		<section class="row component-section">
			...
			<div class="col-md-12">
                ...
                small icon.</p>
				<p>To use any of the icon you just need to add a class taking reference from the name of icon.<br><strong>For example:</strong> To use the 3d rotation icon, add <code><</code><code>i class="material-icons md-dark pmd-md"</code><code>></code><code>3d_rotation</code><code><</code><code>/i</code><code>></code>.</p>
			...
			<div class="col-md-12">
				<div class="component-box"> 
					...
					<div class="pmd-card-title custom-heading clearfix"> 
						<a data-original-title="View Code" href="javascript:void(0);" class="btn btn-sm pmd-btn-fab pmd-btn-flat pmd-ripple-effect btn-primary rotate-90 pull-right" data-toggle="tooltip" data-placement="bottom" title=""><i class="material-icons md-dark pmd-sm">code</i></a>
					...
					<div class="code-box">
						<div class="pmd-tabs">
							...
							<ul class="nav nav-tabs" data-tabs="tabs">
								<li class="active"><a href="#sizes-html" data-toggle="tab">HTML</a></li>
								<li><a href="#sizes-css" data-toggle="tab">CSS</a></li>
							</ul>
						</div>
						<div id="my-tab-content" class="tab-content">
							<div class="tab-pane active" id="sizes-html">
								<pre class="pre-codebox line-numbers" data-src="../components/icons/snippets/icons-sizing-variation.html"></pre>
							</div>
							<div class="tab-pane" id="sizes-css">
								<pre class="pre-codebox line-numbers" data-src="../components/icons/snippets/propeller-icons.css"></pre>
							</div>
						</div>
					</div> <!--code view end-->
                            ...
                            <div class="pmd-card pmd-z-depth pmd-card-custom-view">
								<div class="pmd-card-body text-center">
									<div class="row"> 
										...
										<div class="col-md-3 col-sm-3 col-xs-6">
											<i class="material-icons md-dark pmd-md">mood</i><br>
											<code>pmd-md</code></div>
										<!-- Small Propeller icon -->
										<div class="col-md-3 col-sm-3 col-xs-6">
											<i class="material-icons md-dark pmd-sm">mood</i><br>
											<code>pmd-sm</code></div>
										<!-- Extra small Propeller icon -->
										<div class="col-md-3 col-sm-3 col-xs-6">
											<i class="material-icons md-dark pmd-xs">mood</i><br>
